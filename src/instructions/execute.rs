...
use crate::instructions::v_register::{
    ...
    vfunc_mseq_vv, vfunc_mseq_vx, vfunc_msgt_vi, vfunc_msgt_vx, vfunc_msgtu_vi, vfunc_msgtu_vx,
    vfunc_msle_vv, vfunc_msle_vx, vfunc_msleu_vi, vfunc_msleu_vv, vfunc_msleu_vx, vfunc_mslt_vv,
    vfunc_mslt_vx, vfunc_msltu_vv, vfunc_msltu_vx, vfunc_msne_vi, vfunc_msne_vv, vfunc_msne_vx,
